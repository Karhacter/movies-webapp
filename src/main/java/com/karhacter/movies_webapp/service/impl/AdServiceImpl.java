...
public class AdServiceImpl implements AdService {
    ...
    @Override
    public List<AdDTO> searchAds(String adName, String campaignOwner, String duration, String status) {
        List<Ad> ads = adRepo.searchAds(adName, campaignOwner, duration, status);
        return ads.stream()
                .map(ad -> modelMapper.map(ad, AdDTO.class))
                .collect(Collectors.toList());
    }
