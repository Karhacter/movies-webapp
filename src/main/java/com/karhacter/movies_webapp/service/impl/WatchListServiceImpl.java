...
public class WatchListServiceImpl implements WatchListService {
    ...
    @Override
    public Page<WatchlistDTO> getUserWatchlist(Long userId, Pageable pageable) {
        User user = userRepo.findById(userId).orElseThrow(() -> new RuntimeException("User not found"));
        Page<Watchlist> watchlistsPage = watchlistRepo.findByUser(user, pageable);
        return watchlistsPage.map(watchlist -> new WatchlistDTO(
                watchlist.getId(),
                watchlist.getCreated_at(),
